...
export default function ProductionGridPage() {
  ...
  const stations = [
    { 
      ...
      name: "Module Line", 
      icon: Boxes, 
      path: "/dashboard/production/module-line", 
      description: "LH & RH module cell scanning and sub-assembly logging" 
    },
    { 
      id: "battery-pack", 
      name: "Battery Pack Line", 
      icon: BatteryCharging, 
      path: "/dashboard/production/pack-line", 
      description: "Pack assembly, BMS binding & serial validation station" 
    },
    { 
      id: "leak-test", 
      name: "Leak Test", 
      icon: Wind, 
      path: "/dashboard/production/leak-test", 
      description: "Air leakage testing" 
    },
    { 
      id: "pdi", 
      name: "PDI Station", 
      icon: CheckSquare2, 
      path: "/dashboard/production/pdi", 
      description: "Pre-Delivery Inspection, final physical checks & dispatch tagging" 
    },
  ];
      ...
      <div className="flex items-center gap-3.5 border-b border-slate-200/80 pb-5">
        ...
        <div>
          <h1 className="text-3xl font-black tracking-wider text-slate-900 uppercase">
            Production <span className="text-cyan-600">Stations</span>
          </h1>
